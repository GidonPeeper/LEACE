...
def main():
    ...
    # Step 1: Parse train, valid and test, then concatenate
    ...
    print(f"Parsing {valid_file} for training set...")
    valid_sentences, valid_pos_tags = parse_conllu_with_pos(valid_file)
    print(f"Parsed {len(train_sentences)} training sentences.")
    ...
    all_pos_tags = train_pos_tags.union(valid_pos_tags).union(test_pos_tags)
    ...
    # Save as one file
    save_path = os.path.join(save_dir, "Embed_ud_pos.pkl")
