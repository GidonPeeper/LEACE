#Hier is iets fout met iig de manier waarop de files worden gesaved, kijken of dat het enige probleem is, of dat niets klopt
import pickle
import torch
import numpy as np
...
RESULTS_FILE = "Stage34/Results/Narratives/Synt_deps/leace_probe_results.json"
