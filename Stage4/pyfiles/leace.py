...
# --------------------------
LAYER = 8
EMBEDDING_FILE = "Stage4/Embeddings/Narratives/Synt_deps/Original_embeddings/gpt2_embeddings.pt"
TEST_FILE = "Stage4/Embeddings/Narratives/Synt_deps/Original_embeddings/gpt2_embeddings_test.pt"
RESULTS_FILE = "Stage4/Results/Narratives/Synt_deps/leace.json"
...
os.makedirs("Stage4/Eraser_objects/Narratives/", exist_ok=True)
os.makedirs("Stage4/Embeddings/Narratives/Erased_embeddings/", exist_ok=True)
...
for source_feat in all_pos_tags:
    ...
    with open(f"Stage4/Eraser_objects/Narratives/s4_leace_eraser_{source_feat}.pkl", "wb") as f:
        pickle.dump(eraser, f)
    # ----------------------------------------

    # --- Save the LEACE-erased embeddings for this feature ---
    with open(f"Stage4/Embeddings/Narratives/Erased_embeddings/s4_leace_embeddings_{source_feat}.pkl", "wb") as f:
        pickle.dump({
