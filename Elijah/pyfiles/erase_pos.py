#This file erases pos tags from Narratives sentences with Oracle 
import pickle
import torch
import numpy as np
...
# --------------------------
LAYER = 8
EMBEDDING_FILE = "Elijah/Embeddings/original_embeddings_pos.pkl"
RESULTS_FILE = "Elijah/Results/remove_pos.json"
...
with open("Elijah/Embeddings/narratives_without_pos.pkl", "wb") as f:
    pickle.dump({
...
with open("Elijah/Eraser_objects/oracle_transf_matrix_pos.pkl", "wb") as f:
